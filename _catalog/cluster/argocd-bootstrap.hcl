# Shared ArgoCD bootstrap cluster stack configuration.
# Include this from: live/<env>/cluster/argocd-bootstrap/terragrunt.hcl
...
terraform {
  source = "${get_repo_root()}/modules/cluster/argocd-bootstrap"
}
...
inputs = {
  ...
  argocd_version     = local.l.argocd_version
